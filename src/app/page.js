    ...
    return (
      <div className="relative flex min-h-screen flex-col overflow-hidden text-white">
        ...
        <header className="relative z-50 flex items-center justify-between px-6 py-6 sm:grid sm:grid-cols-[1fr_auto_1fr] sm:items-center sm:px-12">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm font-medium backdrop-blur-md sm:flex sm:justify-self-center">
        ...
        >
          <div className="flex flex-col items-center gap-6 sm:max-w-3xl">
            <h1
              className={`text-4xl font-extrabold leading-[1.05] tracking-tight text-white sm:text-5xl md:text-6xl transition-all duration-1000 ${
            ...
            >
              ...
              <br className="hidden sm:block" /> a Front-End Developer
            </h1>

            <div
              className={`flex flex-col items-center justify-center gap-10 mt-20 transition-all duration-1000 delay-300 ${
                isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            >
              <p className="max-w-2xl text-base text-white/70 sm:text-lg">
                I build sleek, high-performing front-end experiences using Next.js
                and modern web technologies. From dynamic layouts to pixel-perfect
                interactions, I&apos;m passionate about transforming creative
                ideas into responsive, accessible, and user-focused digital
                interfaces.
              </p>
              <button
